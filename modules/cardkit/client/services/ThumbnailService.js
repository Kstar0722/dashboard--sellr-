...
/**
 * Adjusted https://github.com/kennyki/angular-thumbnail to handle cross origin policy correctly.
 */
angular.module('cardkit.core').provider('ThumbnailService', function() {
