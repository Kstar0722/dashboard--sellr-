        ...
        '$scope', '$attrs', function ($scope, $attrs) {
          ...
          findCountriesIn = (function (_this) {
            return function (codesString) {
              ...
              for (i = 0, len = ref.length; i < len; i++) {
                country = ref[ i ]
                ref1 = country.code
                if (indexOf.call(countryCodes, ref1) >= 0) {
          ...
          includeOnlyRequestedCountries = (function (_this) {
            return function () {
              ...
              _this.countries = findCountriesIn($scope.only)
          ...
          $scope.isSelectionOptional = $attrs.csRequired === void 0
          return $scope.isSelectionOptional
        }
      ]
    }
  })
