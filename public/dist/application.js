...
'use strict';
angular.module('users').service('productEditorService', ["$http", "$location", "constants", "Authentication", "$stateParams", "$q", "toastr", "$rootScope", function ($http, $location, constants, Authentication, $stateParams, $q, toastr, $rootScope) {
    var me = this;
    var debugLogs = true;
